...
| "Stall." | The factual stall line, with the stalls-lane icon (per the active theme) rendered above it by the presentation layer. |
...
Hard rule 9 binds: the mood line counts icons as flavor; the brief
